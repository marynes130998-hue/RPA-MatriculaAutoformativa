...
# RENIEC
BASE_URL_RENIEC_CAP  = os.getenv("BASE_URL_RENIEC_CAP")
BASE_URL_RENIEC_PROD = os.getenv("BASE_URL_RENIEC_PROD")
TOKEN_RENIEC         = os.getenv("TOKEN_RENIEC")

# SIFODS PERFIL DOCENTE
BASE_URL_SIFODS_PERFIL_DOCENTE_CAP  = os.getenv("BASE_URL_SIFODS_PERFIL_DOCENTE_CAP")
BASE_URL_SIFODS_PERFIL_DOCENTE_PROD = os.getenv("BASE_URL_SIFODS_PERFIL_DOCENTE_PROD")
TOKEN_SIFODS_PERFIL_DOCENTE         = os.getenv("TOKEN_SIFODS_PERFIL_DOCENTE")
